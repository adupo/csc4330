(function($) {
  ...
  var root = this,
      previousDuoMonkeyEditorUI = root.DuoMonkeyEditorUI;

  root.DuoMonkeyEditorUI = DuoMonkeyEditorUI;

  if (!self.DuoMonkeyEditorDefaultTemplates) {
    throw new Error("Unable to find chat templates!");
  }

  function DuoMonkeyEditorUI(firebaseRef, el, options) {
    var self = this;

    if (!firebaseRef) {
      throw new Error('DuoMonkeyEditorUI: Missing required argument `firebaseRef`');
    }

    if (!el) {
      throw new Error('DuoMonkeyEditorUI: Missing required argument `el`');
    }
    ...
    this._el = el;
    this._user = null;
    this._chat = new DuoMonkeyEditor(firebaseRef, options);
  ...
  // Run DuoMonkeyEditorUI in *noConflict* mode, returning the `DuoMonkeyEditorUI` variable to
  // its previous owner, and returning a reference to the DuoMonkeyEditorUI object.
  DuoMonkeyEditorUI.noConflict = function noConflict() {
    root.DuoMonkeyEditorUI = previousDuoMonkeyEditorUI;
    return DuoMonkeyEditorUI;
  };

  DuoMonkeyEditorUI.prototype = {
    ...
    _renderLayout: function() {
      var template = DuoMonkeyEditorDefaultTemplates["templates/layout-full.html"];
    ...
    _onChatInvite: function(invitation) {
      var self = this;
      var template = DuoMonkeyEditorDefaultTemplates["templates/prompt-invitation.html"];
    ...
    _onChatInviteResponse: function(invitation) {
      ...
      var self = this,
          template = DuoMonkeyEditorDefaultTemplates["templates/prompt-invite-reply.html"],
          $prompt;
   ...
   */
  DuoMonkeyEditorUI.prototype.setUser = function(userId, userName) {
    var self = this;
   ...
   */
  DuoMonkeyEditorUI.prototype.on = function(eventType, cb) {
    var self = this;
   ...
   */
  DuoMonkeyEditorUI.prototype._bindSuperuserUIEvents = function() {
    var self = this,
        ...
        showMessageContextMenu = function(event) {
          var $this = $(this),
              ...
              template = DuoMonkeyEditorDefaultTemplates["templates/message-context-menu.html"],
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForHeightChange = function() {
    var self = this,
        $el = $(this._el),
        lastHeight = null;
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForTabControls = function() {
    var self = this;
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForRoomList = function() {
    var self = this;
    ...
    $('#firechat-btn-rooms').bind('click', function() {
      ...
      var $this = $(this),
          template = DuoMonkeyEditorDefaultTemplates["templates/room-list-item.html"],
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForUserRoomList = function() {
    var self = this;
    ...
    $(document).delegate('[data-event="firechat-user-room-list-btn"]', 'click', function(event) {
      ...
      var $this = $(this),
          ...
          template = DuoMonkeyEditorDefaultTemplates["templates/room-user-list-item.html"],
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForUserSearch = function() {
    var self = this,
        ...
        userSearch = function(targetId, templateId, controlsId, prefix, startAt, endAt) {
          var $target = $('#' + targetId),
              $controls = $('#' + controlsId),
              template = DuoMonkeyEditorDefaultTemplates[templateId];
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForUserMuting = function() {
    var self = this;
    $(document).delegate('[data-event="firechat-user-mute-toggle"]', 'click', function(event) {
      var $this = $(this),
          ...
          template = DuoMonkeyEditorDefaultTemplates["templates/prompt-user-mute.html"];
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForChatInvites = function() {
    var self = this,
        renderInvitePrompt = function(event) {
          var $this = $(this),
              ...
              roomId = $this.closest('[data-room-id]').data('room-id'),
              userName = $this.closest('[data-user-name]').data('user-name'),
              template = DuoMonkeyEditorDefaultTemplates["templates/prompt-invite-private.html"],
              $prompt;
          ...
          self._chat.getRoom(roomId, function(room) {
            ...
            $prompt.find('[data-toggle=accept]').first().click(function() {
              $prompt.remove();
              self._chat.inviteUser(userId, roomId);
              return false;
            });
            return false;
          });
        ...
        renderPrivateInvitePrompt = function(event) {
          ...
          if (userId && userName) {
            ...
            $prompt.find('[data-toggle=accept]').first().click(function() {
              ...
              self._chat.createRoom(roomName, roomPassword, 'private', function(roomId) {
                self._chat.inviteUser(userId, roomId);
              });
              return false;
            });
   ...
   */
  DuoMonkeyEditorUI.prototype._bindForRoomListing = function() {
    var self = this,
   ...
   */
  DuoMonkeyEditorUI.prototype._setupTabs = function() {
    var self = this,
        show = function($el) {
          var $this = $el,
   ...
   */
  DuoMonkeyEditorUI.prototype._setupDropdowns = function() {
    var self = this,
   ...
   */
  DuoMonkeyEditorUI.prototype._bindTextInputFieldLimits = function() {
   ...
   */
  DuoMonkeyEditorUI.prototype.renderAlertPrompt = function(title, message) {
    var template = DuoMonkeyEditorDefaultTemplates["templates/prompt-alert.html"],
   ...
   */
  DuoMonkeyEditorUI.prototype.toggleInputs = function(isEnabled) {
   ...
   */
  DuoMonkeyEditorUI.prototype.attachTab = function(roomId, roomName) {
    var self = this;
    ...
    var tabTemplate = DuoMonkeyEditorDefaultTemplates["templates/tab-content.html"];
    ...
    var tabListTemplate = DuoMonkeyEditorDefaultTemplates["templates/tab-menu-item.html"];
   ...
   * @param    {string}    roomId
   */
  DuoMonkeyEditorUI.prototype.focusTab = function(roomId) {
    if (this.$messages[roomId]) {
   ...
   * @param    {string}    roomId
   */
  DuoMonkeyEditorUI.prototype.removeTab = function(roomId) {
   ...
   * @param    {string}    message
   */
  DuoMonkeyEditorUI.prototype.showMessage = function(roomId, rawMessage) {
    var self = this;
    ...
    var template = DuoMonkeyEditorDefaultTemplates["templates/message.html"];
   ...
   */
  DuoMonkeyEditorUI.prototype.removeMessage = function(roomId, messageId) {
   ...
   */
  DuoMonkeyEditorUI.prototype.sortListLexicographically = function(selector) {
   ...
   * @return   {string}
   */
  DuoMonkeyEditorUI.prototype.trimWithEllipsis = function(str, length) {
   ...
   * @param    {string}    date
   */
  DuoMonkeyEditorUI.prototype.formatTime = function(timestamp) {
  ...
  /**
   * Launch a prompt to allow the user to create a new session.
   */
  DuoMonkeyEditorUI.prototype.promptCreateRoom = function() {
    var self = this;
    var template = DuoMonkeyEditorDefaultTemplates["templates/prompt-create-room.html"];

    var $prompt = this.prompt('Create a session', template({
    ...
    $prompt.find('[data-toggle=submit]').first().click(function() {
      ...
      var password = $prompt.find('[data-input=firechat-password]').first().val();
      if (name !== '' && password !== '') {
        self._chat.createRoom(name, password, 'public');
        $prompt.remove();
      }
      return false;
    });
    ...
    $prompt.find('[data-input=firechat-password]').first().bind('keydown', function(e) {
      if (e.which === 13) {
        var name = $prompt.find('[data-input=firechat-room-name]').first().val();
        var password = $prompt.find('[data-input=firechat-password]').first().val();
        if (name !== '') {
  ...
  /**
   * Launch a prompt to join a session
   */
  DuoMonkeyEditorUI.prototype.promptJoinRoom = function(roomId) {
    var self = this;
    var template = DuoMonkeyEditorDefaultTemplates["templates/prompt-join-room.html"];

    var $prompt = this.prompt('Join a session', template({
      maxLengthRoomName: this.maxLengthRoomName,
      isModerator: self._chat.userIsModerator()
    }));
    $prompt.find('a.close').first().click(function() {
    ...
    $prompt.find('[data-toggle-submit]').first().click(function() {
      var password = $prompt.find('[data-input=firechat-password]').first().val();
      if (password !== '') {
        self._chat.enterRoom(roomId, password);
        $prompt.remove();
      }
      return false;
    });
   ...
   */
  DuoMonkeyEditorUI.prototype.prompt = function(title, content) {
    var template = DuoMonkeyEditorDefaultTemplates["templates/prompt.html"],
        $prompt;
  ...
  DuoMonkeyEditorUI.prototype.linkify = function(str) {
    var self = this;
    return str
