...
Pre-Conditions: The user must be already logged in to DuoMonkeyEditor<br />
...
<br />
Post-Conditions: A new chat session has been created by the user<br />
...
<br />
Post-Conditions: The user is now in an existing chat session<br />
...
<br />
Post-Conditions: The user did not successfully join an exisitng chat session<br />
...
Pre-Condition: The user must be already logged in to DuoMonkeyEditor and joined or created a chat session<br />
...
<br />
Post-Conditions: The users may now use the text editor feature within chat session
